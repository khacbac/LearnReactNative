...
import { Platform, StyleSheet, Text, View, TouchableOpacity, FlatList, Image, Dimensions } from 'react-native';
...
const datas = [
    ...
    },
    {
        ...
        description: "Macbook Pro Retina 13 inch 2015 MF840 Core i5 8GB 256GB Like new",
        price: 1000,
        count: 0
    },
    {
        ...
        description: "Macbook Pro TouchBar 13 inch 2017 MPXV2 Core i5 256GB 8GB RAM – Like new",
        price: 1360,
        count: 0
    },
    {
...
export default class Home extends React.Component {
    ...
    _renderHeader = () => {
        return (
            <Header title="Shop" rightIcon="shopping-basket" leftIcon="chevron-left" />
        )
    }
        ...
        return (
            <View style={{
                ...
                <Text style={{ color: 'gray' }}>
                    <Text style={{ color: 'black' }}>{this.state.datas.length}{" "}</Text>items
                </Text>
            </View>
        )
    }
    ...
    _renderTotalView = () => {
        ...
        return (
            <View style={{
                ...
                <Text style={{ color: 'gray' }}>
                    {"Total: "}<Text style={{ color: 'black' }}>{`$${total}`}</Text>
                </Text>
                <Text style={{ color: 'gray', marginLeft: 50, marginRight: 10 }}>
                    {"Quanlity: "}<Text style={{ color: 'black' }}>{quanlity}</Text>
                </Text>
            </View>
        )
    }
